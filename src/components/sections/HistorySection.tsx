      ...
      {!connected ? (
        ...
        <div className="bg-[#141414] border border-[#2A2A2A] p-10 text-center">
          ...
          <p className="text-[#888888] font-['Inter'] text-xs">
            Shield a token in Portfolio to create your first transaction.
          </p>
        </div>
              ...
              {txList.map((tx, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 sm:px-5 py-3 font-['JetBrains_Mono'] text-xs">
                      {url ? (
                        <a
                          href={url}
                          target="_blank"
                        ...
                        <span className="text-[#555]">{tx.signature.slice(0, 6)}...{tx.signature.slice(-4)}</span>
                      )}
                    </td>
                  </tr>
                );
