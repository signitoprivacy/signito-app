...
import sketchNonCustodial from "../assets/sketch-noncustodial-flow.jpg";
          ...
          <div className="border-b border-[#E0E0E0]">
            <div className="max-w-[1200px] mx-auto px-8 md:px-16 py-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-[#E0E0E0]">
                {[
                  { title: "Shielded Vault", body: "Withdrawals require a valid OTS pre-image from your PBKDF2 chain. The program cannot be instructed by Signito, by a court order, or by anyone to bypass this check. The code is the rule." },
            ...
            <div className="max-w-[1200px] mx-auto px-8 md:px-16 py-20">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { q: "Does Signito charge a fee?", a: "Yes, a transparent 0.15% protocol fee is applied to each withdrawal and enforced on-chain by the program. The fee is not hidden: it is visible in the transaction before you sign, deducted from the withdrawal amount, and credited to the protocol treasury PDA. There is no additional silent deduction beyond this published rate." },
                ].map((item) => (
